...
public static class SpearMintInterface {
        ...
        [DllImport ("spearmint")]
        public static extern ulong spear_ligand_add_atom_to(ulong atom, ulong element);
        ...
        public static void Main() {
            ...
            try {
                ...
                if (spear_ligand_add_atom_to(0, 6) == 0) {
                ...
                ulong new_atom1 = spear_ligand_add_atom_to(0, 6);

                Console.WriteLine( "Score is : " + spear_calculate_score() );

                ulong new_atom2 = spear_ligand_add_atom_to(0, 6);
