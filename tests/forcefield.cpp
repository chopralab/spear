...
TEST_CASE("Bonds") {
    std::unordered_set<std::array<size_t, 2>,
                       Spear::BondedForcefield::bond_type_hash,
                       Spear::BondedForcefield::bond_type_equal> bond_set;
...
TEST_CASE("Angles") {
    std::unordered_set<std::array<size_t, 3>,
                       Spear::BondedForcefield::angle_type_hash,
                       Spear::BondedForcefield::angle_type_equal> angle_set;
...
TEST_CASE("Torsions") {
    std::unordered_set<std::array<size_t, 4>,
                       Spear::BondedForcefield::torsion_type_hash,
                       Spear::BondedForcefield::torsion_type_equal> proper_set;

    Spear::BondedForcefield::torsion_type_hash hasher;
    Spear::BondedForcefield::torsion_type_equal checker;
